...
1. Further select your branch from the `Branch:` dropdown (e.g. `carmlLab`)
    ...
    <img src="./media/Lab5/actionBranch.png" alt="Select branch" height="200">
...
In case the dependency pipeline of [Lab 3](./Lab%203%20-%20Deploy%20Dependencies) failed to deploy the required proximity placement group for any reason, you can use the below instructions to create it manually from the Azure portal:
